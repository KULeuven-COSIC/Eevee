...
int jolteon_forkskinny_64_192_encrypt(
...
int jolteon_forkskinny_64_192_decrypt(
...
int jolteon_forkskinny_128_256_encrypt(
    /** ciphertext destination buffer */
    unsigned char *c,
    /** tag destination buffer */
    unsigned char *tag,
...
int jolteon_forkskinny_128_256_decrypt(
    /** message destination buffer */
    unsigned char *m,
    /** ciphertext and length */
    const unsigned char *c,unsigned long long clen,
